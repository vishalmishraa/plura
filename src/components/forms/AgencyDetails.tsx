    ...
    const handleDeleteAgency = async(data: any) => {
        ...
        try{
            ...
            toast({
                variant: 'destructive',
                title: 'Oppse!',
                description: 'Failed to delete your agency. Please try again.'
              });
        }
        ...
        <AlertDialog>
            <Card className='w-full'>
                ...
                <CardContent>
                    ...
                    {data?.id && (
                        <div className="flex flex-col md:flex-row md:items-center justify-between rounded-lg border border-destructive gap-4 p-4 mt-4">
                        <div >
                            <div>Danger Zone</div>
                        </div>
